...
const JoinFiver = () => {
  return (
    ...
    <div className='absolute sm:left-[10px] xl:left-[100px] xl:top-[100px] left-[30px] top-[30px] flex flex-col gap-[30px]  sm:gap-2'>
        ...
        <button className=' text-white text-[18px] px-3 font-semibold bg-[var(--primaryColor)] w-fit sm:p-2 sm:text-[12px] sm:py-2 py-[10px] rounded-[5px] hover:opacity-[0.9] transition-all'>Join Freelance</button>
    </div>
